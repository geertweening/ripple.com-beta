    ...
    async.waterfall([
      function (callback) {
        ...
        function next(xhr, status) {
          ...
          if (!urls.length) {
            var tips = 'Check if the file is actually hosted at one of the URLs'
                  + ' above and make sure your server provides the required <a'
                  + ' href="https://ripple.com/wiki/Ripple.txt#Publishing_ripple.txt">CORS header.</a>';
