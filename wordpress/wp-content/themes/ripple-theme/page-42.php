		...
		<div class="wrapper cf">
			...
			<div class="content-area">
				<div class="entry-content">
                    <section>
                        <h3 class="title"><a id="technical-summary" class="anchor">Technical Summary</a></h3>
                        <div class="block">
                    ...
                    <section>
                        <h3 class="title"><a id="virtual-currency" class="anchor">Virtual Currency</a></h3>
                    ...
                    <section>
                        <h3 class="title"><a id="the-open-platform" class="anchor">The Open Platform</a></h3>
