<?php
/**
 * The template used for displaying page content in topic-payment-network.php
 *
 * @packageRipple
 */
?>
<!-- Begin content-guide-payment-network.php -->
			<div class="scrollspy-area col-8 pull-right" data-offset="100">
				...
				<section class="guide-section">
					...
					<p>All accounts and transactions are cryptographically secure and algorithmically verified. Payments can only be authorized by the account holder and all payments are processed automatically without any third-parties or intermediaries. And because Ripple is a distributed system, there is no single point of weakness or attack.</p>
				</section>
				<section class="guide-section">
					<h5 id="accessible-to-everyone">Accessible to Everyone</h5>
					<p>Anyone with an Internet connection can create a Ripple account in seconds. It’s not just convenient—Ripple offers financial services to millions of people around the world without access to banks or services.</p>
 				</section>
 				<section class="guide-section">
				...
				<section class="guide-section">
					<h5 id="no-merchant-fees">No Merchant Fees</h5>
					<p>Receiving payments in Ripple is always free. That means merchants always get 100% of their payment. Goodbye transaction fees. Hello profit margin.</p> 
				</section>
				<section class="guide-section">
					<h5 id="micropayments">Micropayments</h5>
					<p>With Ripple, you can make payments of any size. A penny? One tenth of a penny? No problem. Micropayments make new pricing systems and business models possible.</p>
				</section>
				<section class="guide-section">
				...
				<section class="guide-section">
					...
					<p>Ripple gateways are organizations that allow you to move money in and out of the Ripple network. As a result, most Ripple users will want to have an association with at least one gateway. Understanding gateways is an important part of understanding Ripple.</p>
				</section>
				<section class="guide-section">
